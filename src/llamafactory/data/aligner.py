...
def align_dataset(
    ...
    elif dataset_attr.formatting == "sharegpt_stream":
        convert_func = partial(convert_sharegpt_stream, dataset_attr=dataset_attr, data_args=data_args)
    else:
