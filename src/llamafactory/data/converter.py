...
@dataclass
class SharegptStreamDatasetConverter(DatasetConverter):
    def __call__(self, example: dict[str, Any]) -> dict[str, Any]:
        # import pdb; pdb.set_trace()
        # print("Debug: Converts sharegpt format dataset to the standard format.")
...
DATASET_CONVERTERS = {
    ...
    "sharegpt_stream": SharegptStreamDatasetConverter
}
