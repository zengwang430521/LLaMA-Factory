...
class Qwen2_5_VLStreamConfigV3(Qwen2_5_VLConfig):
...
class Qwen2_5_VLStreamV3(Qwen2_5_VLForConditionalGeneration):
    config_class = Qwen2_5_VLStreamConfigV3
            ...
            if (stream_labels != -100).sum() > 0:
                ...
                if self.stream_head_dim == 2:
                    ...
                    if self.stream_loss_type == 'focal_loss':
                        ...
                        # bce loss
                        stream_loss = F.binary_cross_entropy_with_logits(
                            stream_logits, stream_labels.float(), reduction='none')
...
AutoConfig.register('qwen2_5_vl_stream_v3', Qwen2_5_VLStreamConfigV3)
AutoModelForVision2Seq.register(Qwen2_5_VLStreamConfigV3, Qwen2_5_VLStreamV3)